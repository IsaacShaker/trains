...
class BlockOccupancy(QWidget):
    def __init__(self, line, mode, editable=False):
        super().__init__()
        self.line = line
        self.mode = mode
        self.track_data = {}
        ...
        # Set checkbox interaction based on the editable flag
    ...
    def refresh(self, line, mode):
        ...
        self.checkboxes = []
        for i in range(15):  # Ensure we always create 15 checkboxes
            block = self.track_data[self.line][self.mode]["blocks"][i]
