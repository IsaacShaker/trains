...
class TestBlockOccupancy(unittest.TestCase):
    def setUp(self):
        ...
        self.block_occupancy = BlockOccupancy("Blue", "HW")  # Ensure valid parameters

    def test_initial_checkbox_state(self):
        block_data = self.block_occupancy.track_data[self.block_occupancy.line][self.block_occupancy.mode]["blocks"]
    ...
    def test_checkbox_toggle(self):
        ...
        checkbox.toggle()
        self.assertEqual(self.block_occupancy.track_data[self.block_occupancy.line][self.block_occupancy.mode]["blocks"][0]["occupied"], not initial_state)
